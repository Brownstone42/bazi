...
function buildLifeAreas(chart, assessment, dayProfile, scores) {
  ...
  return [
    ...
    },
    {
      ...
      shouldAvoid: 'ใช้คำอ่านนี้วินิจฉัยโรค ปรับยา หรือเลื่อนการพบแพทย์เมื่อมีอาการผิดปกติ',
      disclaimer: 'ส่วนนี้อธิบายรูปแบบการใช้พลังเท่านั้น ไม่ใช่การตรวจหรือวินิจฉัยสุขภาพ'
    }
  ]
}
